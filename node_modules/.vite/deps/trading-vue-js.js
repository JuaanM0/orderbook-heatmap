...
var require_trading_vue = __commonJS({
  "node_modules/trading-vue-js/dist/trading-vue.js"(exports, module) {
      ...
      return (() => {
        var __webpack_modules__ = {
          757: (module2, __unused_webpack_exports, __webpack_require__2) => {
            module2.exports = __webpack_require__2(666);
          },
          546: (module2) => {
            module2.exports = {
              numcmp: function(a, b) {
          ...
          678: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var util = __webpack_require__2(500), cmp = __webpack_require__2(546), bin = __webpack_require__2(101);
          ...
          851: (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
            "use strict";
            ...
            var lib = __webpack_require__2(678);
            var lib_default = __webpack_require__2.n(lib);
            ;
            const utils = {
            ...
            ;
            function layout_fn(self2, range) {
            ...
            function GridMaker(id, params, master_grid) {
              ...
              function calc_$range() {
                if (!master_grid) {
                  if (y_range_fn) {
                    var _y_range_fn = y_range_fn(hi, lo), _y_range_fn2 = _slicedToArray(_y_range_fn, 2), hi = _y_range_fn2[0], lo = _y_range_fn2[1];
                  } else {
                  ...
                  if (y_range_fn) {
                    var _y_range_fn3 = y_range_fn(hi, lo), _y_range_fn4 = _slicedToArray(_y_range_fn3, 3), hi = _y_range_fn4[0], lo = _y_range_fn4[1], exp = _y_range_fn4[2];
                  }
                }
              ...
              function calc_precision(data) {
                ...
                [min, max].forEach(function(x2) {
                  var str = x2 != null ? x2.toString() : "";
                  if (x2 < 1e-6) {
                    var _str$split = str.split("e-"), _str$split2 = _slicedToArray(_str$split, 2), ls2 = _str$split2[0], rs = _str$split2[1];
                    var _ls$split = ls2.split("."), _ls$split2 = _slicedToArray(_ls$split, 2), l = _ls$split2[0], r = _ls$split2[1];
                    if (!r)
                      r = "";
                    r = {
                    ...
                    var _str$split3 = str.split("."), _str$split4 = _slicedToArray(_str$split3, 2), l = _str$split4[0], r = _str$split4[1];
                  }
                  if (r && r.length > max_r) {
                    max_r = r.length;
                  }
            ...
            function Layout(params) {
              ...
              function candles_n_vol() {
                ...
                var hf_px_step = self2.px_step * 0.5;
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                  var _step$value = _slicedToArray(_step.value, 2), i = _step$value[0], _step$value$ = _step$value[1], data = _step$value$.data, grid = _step$value$.grid;
                  specs.sub = data;
                  specs.height = hs[i + 1];
                  specs.y_t = y_ts[i + 1];
                  specs.grid = grid || {};
            ...
            var CursorUpdater = function() {
              function CursorUpdater2(comp) {
                classCallCheck_classCallCheck(this, CursorUpdater2);
                this.comp = comp, this.grids = comp._layout.grids, this.cursor = comp.cursor;
              }
              createClass_createClass(CursorUpdater2, [{
                key: "sync",
              ...
              return CursorUpdater2;
            }();
            const updater = CursorUpdater;
            ;
            ...
            var FrameAnimation = function() {
              function FrameAnimation2(cb) {
                var _this = this;
                classCallCheck_classCallCheck(this, FrameAnimation2);
                this.t0 = this.t = utils.now();
                this.id = setInterval(function() {
                  if (utils.now() - _this.t > 100)
                    return;
              ...
              createClass_createClass(FrameAnimation2, [{
                key: "stop",
                value: function stop() {
            ...
            var hammer = __webpack_require__2(840);
            var hamster = __webpack_require__2(981);
            var hamster_default = __webpack_require__2.n(hamster);
            ;
            ...
            var Grid = function() {
              function Grid2(canvas2, comp) {
                classCallCheck_classCallCheck(this, Grid2);
              ...
              createClass_createClass(Grid2, [{
                ...
                value: function pan_fade(event) {
                  ...
                  if (this.fade)
                    this.fade.stop();
                  this.fade = new FrameAnimation(function(self2) {
                    v *= 0.85;
                    if (Math.abs(v) < v0) {
                      self2.stop();
                    }
                ...
                value: function apply_shaders() {
                  var layout2 = this.$p.layout.grids[this.id];
                  var props = {
                    layout: layout2,
                    range: this.range,
                    interval: this.interval,
                    tf: layout2.ti_map.tf,
                    cursor: this.cursor,
                ...
                value: function grid() {
                  ...
                  try {
                    for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
                      var _step2$value = _slicedToArray(_step2.value, 2), x = _step2$value[0], p = _step2$value[1];
                  ...
                  try {
                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
                      var _step3$value = _slicedToArray(_step3.value, 2), y = _step3$value[0], y$ = _step3$value[1];
            ...
            const canvas = {
              methods: {
                setup: function setup() {
                  ...
                  canvas2.style.width = "".concat(this._attrs.width, "px");
                  canvas2.style.height = "".concat(this._attrs.height, "px");
                  if (dpr < 1)
                    dpr = 1;
            ...
            var Crosshair = function() {
              function Crosshair2(comp) {
                classCallCheck_classCallCheck(this, Crosshair2);
                this.comp = comp;
                this.$p = comp.$props;
                this.data = this.$p.sub;
                this._visible = false;
              ...
              createClass_createClass(Crosshair2, [{
                key: "draw",
            ...
            ;
            const Crosshairvue_type_script_lang_js_ = {
              name: "Crosshair",
            ...
            ;
            const components_Crosshairvue_type_script_lang_js_ = Crosshairvue_type_script_lang_js_;
            ;
            ...
            const components_Crosshair = component.exports;
            ;
            const KeyboardListenervue_type_script_lang_js_ = {
            ...
            ;
            const components_KeyboardListenervue_type_script_lang_js_ = KeyboardListenervue_type_script_lang_js_;
            ;
            ...
            const KeyboardListener = KeyboardListener_component.exports;
            ;
            ...
            ;
            const UxWrappervue_type_script_lang_js_ = {
              name: "UxWrapper",
            ...
            ;
            const components_UxWrappervue_type_script_lang_js_ = UxWrappervue_type_script_lang_js_;
            var UxWrappervue_type_style_index_0_lang_css_ = __webpack_require__2(565);
            ;
            ;
            ;
            ...
            const UxWrapper = UxWrapper_component.exports;
            ;
            const UxLayervue_type_script_lang_js_ = {
              name: "UxLayer",
            ...
            ;
            const components_UxLayervue_type_script_lang_js_ = UxLayervue_type_script_lang_js_;
            ;
            ;
            ...
            const UxLayer = UxLayer_component.exports;
            ;
            ...
            var Mouse = function() {
              function Mouse2(comp) {
                classCallCheck_classCallCheck(this, Mouse2);
                this.comp = comp;
                this.map = {};
                this.listeners = 0;
                this.pressed = false;
              ...
              createClass_createClass(Mouse2, [{
                key: "on",
            ...
            ;
            const Splinevue_type_script_lang_js_ = {
              name: "Spline",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
                ...
                draw: function draw(ctx) {
                  ...
                  if (!this.skip_nan) {
                    for (var k = 0, n = data.length; k < n; k++) {
                      var p = data[k];
                      var x = layout2.t2screen(p[0]);
                      var y = layout2.$2screen(p[i]);
                      ctx.lineTo(x, y);
                    }
                  } else {
                    var skip = false;
                    for (var k = 0, n = data.length; k < n; k++) {
                      var _p = data[k];
                      var _x = layout2.t2screen(_p[0]);
                      var _y = layout2.$2screen(_p[i]);
                      if (_p[i] == null || _y !== _y) {
                        skip = true;
                      } else {
                        if (skip)
            ...
            ;
            const overlays_Splinevue_type_script_lang_js_ = Splinevue_type_script_lang_js_;
            ;
            ...
            const Spline = Spline_component.exports;
            ;
            const Splinesvue_type_script_lang_js_ = {
              name: "Splines",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
            ...
            ;
            const overlays_Splinesvue_type_script_lang_js_ = Splinesvue_type_script_lang_js_;
            ;
            ...
            const Splines = Splines_component.exports;
            ;
            const Rangevue_type_script_lang_js_ = {
              name: "Range",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
                ...
                draw: function draw(ctx) {
                  var layout2 = this.$props.layout;
                  var upper = layout2.$2screen(this.sett.upper || 70);
                  var lower = layout2.$2screen(this.sett.lower || 30);
                  var data = this.$props.data;
                  ctx.lineWidth = this.line_width;
                  ctx.strokeStyle = this.color;
                  ctx.beginPath();
                  ...
                  ctx.fillRect(0, upper, layout2.width, lower - upper);
                  ctx.moveTo(0, upper);
                  ctx.lineTo(layout2.width, upper);
                  ctx.moveTo(0, lower);
                  ctx.lineTo(layout2.width, lower);
                  ctx.stroke();
                },
                use_for: function use_for() {
                  return ["Range", "RSI"];
            ...
            ;
            const overlays_Rangevue_type_script_lang_js_ = Rangevue_type_script_lang_js_;
            ;
            ...
            const Range = Range_component.exports;
            ;
            const Tradesvue_type_script_lang_js_ = {
              name: "Trades",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
            ...
            ;
            const overlays_Tradesvue_type_script_lang_js_ = Tradesvue_type_script_lang_js_;
            ;
            ...
            const Trades = Trades_component.exports;
            ;
            const Channelvue_type_script_lang_js_ = {
              name: "Channel",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
                ...
                draw: function draw(ctx) {
                  var data = this.data;
                  var layout2 = this.layout;
                  ctx.beginPath();
                  ctx.fillStyle = this.back_color;
                  for (var i = 0; i < data.length; i++) {
                    var p = data[i];
                    var x = layout2.t2screen(p[0]);
                    var y = layout2.$2screen(p[1] || void 0);
                    ctx.lineTo(x, y);
                  }
                  for (var i = data.length - 1; i >= 0; i--) {
                    var _p = data[i];
                    var _x = layout2.t2screen(_p[0]);
                    var _y = layout2.$2screen(_p[3] || void 0);
                    ctx.lineTo(_x, _y);
                  }
                  ctx.fill();
                  ctx.lineWidth = this.line_width;
                  ...
                  for (var i = 0; i < data.length; i++) {
                    var _p2 = data[i];
                    var _x2 = layout2.t2screen(_p2[0]);
                    var _y2 = layout2.$2screen(_p2[1] || void 0);
                    ctx.lineTo(_x2, _y2);
                  }
                  ctx.stroke();
                  ctx.beginPath();
                  for (var i = 0; i < data.length; i++) {
                    var _p3 = data[i];
                    var _x3 = layout2.t2screen(_p3[0]);
                    var _y3 = layout2.$2screen(_p3[3] || void 0);
                    ctx.lineTo(_x3, _y3);
                  }
                  ctx.stroke();
                  if (!this.show_mid)
                  ...
                  for (var i = 0; i < data.length; i++) {
                    var _p4 = data[i];
                    var _x4 = layout2.t2screen(_p4[0]);
                    var _y4 = layout2.$2screen(_p4[2] || void 0);
                    ctx.lineTo(_x4, _y4);
                  }
                  ctx.stroke();
                },
                mapp: function mapp(p) {
                  var layout2 = this.$props.layout;
                  return p && {
                    x: layout2.t2screen(p[0]),
                    y1: layout2.$2screen(p[1]),
                    y2: layout2.$2screen(p[2]),
                    y3: layout2.$2screen(p[3])
                  };
                },
                use_for: function use_for() {
            ...
            ;
            const overlays_Channelvue_type_script_lang_js_ = Channelvue_type_script_lang_js_;
            ;
            ...
            const Channel = Channel_component.exports;
            ;
            const Segmentvue_type_script_lang_js_ = {
              name: "Segment",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
                ...
                draw: function draw(ctx) {
                  ...
                  ctx.beginPath();
                  var layout2 = this.$props.layout;
                  var x1 = layout2.t2screen(this.p1[0]);
                  var y1 = layout2.$2screen(this.p1[1]);
                  ctx.moveTo(x1, y1);
                  var x2 = layout2.t2screen(this.p2[0]);
                  var y2 = layout2.$2screen(this.p2[1]);
                  ctx.lineTo(x2, y2);
                  ctx.stroke();
                },
                use_for: function use_for() {
            ...
            ;
            const overlays_Segmentvue_type_script_lang_js_ = Segmentvue_type_script_lang_js_;
            ;
            ...
            const Segment = Segment_component.exports;
            ;
            function layout_cnv(self2) {
              var $p = self2.$props;
              var sub = $p.data;
              var t2screen = $p.layout.t2screen;
              var layout2 = $p.layout;
              var candles = [];
              var volume = [];
              var maxv = Math.max.apply(Math, _toConsumableArray(sub.map(function(x) {
                return x[5];
              })));
              var vs = $p.config.VOLSCALE * layout2.height / maxv;
              var x1, x2, w, avg_w, mid, prev = void 0;
              var _new_interval = new_interval(layout2, $p, sub), _new_interval2 = _slicedToArray(_new_interval, 2), interval2 = _new_interval2[0], ratio = _new_interval2[1];
              var px_step2 = layout2.px_step * ratio;
              ...
              for (var i = 0; i < sub.length; i++) {
                ...
                candles.push({
                  x: mid,
                  w: layout2.px_step * $p.config.CANDLEW * ratio,
                  o: Math.floor(p[1] * layout2.A + layout2.B),
                  h: Math.floor(p[2] * layout2.A + layout2.B),
                  l: Math.floor(p[3] * layout2.A + layout2.B),
                  c: Math.floor(p[4] * layout2.A + layout2.B),
                  raw: p
                });
                volume.push({
                  x1,
            ...
            function layout_vol(self2) {
              ...
              var vs = volscale * layout2.height / maxv;
              var x1, x2, mid, prev = void 0;
              var _new_interval3 = new_interval(layout2, $p, sub), _new_interval4 = _slicedToArray(_new_interval3, 2), interval2 = _new_interval4[0], ratio = _new_interval4[1];
              var px_step2 = layout2.px_step * ratio;
              var splitter = px_step2 > 5 ? 1 : 0;
              for (var i = 0; i < sub.length; i++) {
                var p = sub[i];
            ...
            function new_interval(layout2, $p, sub) {
              if (!layout2.ti_map.ib) {
                var interval2 = $p.tf || utils.detect_interval(sub);
                var ratio = interval2 / $p.interval;
              } else {
                if ($p.tf) {
                  var ratio = $p.tf / layout2.ti_map.tf;
                  var interval2 = ratio;
                } else {
            ...
            ;
            var CandleExt = function() {
              function CandleExt2(overlay2, ctx, data) {
                classCallCheck_classCallCheck(this, CandleExt2);
                this.ctx = ctx;
                this.self = overlay2;
                this.style = data.raw[6] || this.self;
                this.draw(data);
              }
              createClass_createClass(CandleExt2, [{
                key: "draw",
            ...
            ;
            var VolbarExt = function() {
              function VolbarExt2(overlay2, ctx, data) {
                classCallCheck_classCallCheck(this, VolbarExt2);
                this.ctx = ctx;
                this.$p = overlay2.$props;
                this.self = overlay2;
                this.style = data.raw[6] || this.self;
                this.draw(data);
              }
              createClass_createClass(VolbarExt2, [{
                key: "draw",
                value: function draw(data) {
            ...
            ;
            var Price = function() {
              function Price2(comp) {
                classCallCheck_classCallCheck(this, Price2);
                this.comp = comp;
              }
              createClass_createClass(Price2, [{
                key: "init_shader",
                value: function init_shader() {
                  var _this = this;
                  var layout2 = this.comp.$props.layout;
                  ...
                  this.comp.$emit("new-shader", {
                    ...
                    draw: function draw(ctx) {
                      ...
                      var lbl = bar.price.toFixed(layout2.prec);
                ...
                value: function draw(ctx) {
                  ...
                  var y = layout2.$2screen(last[4]) + (dir ? 1 : 0);
                  ctx.strokeStyle = color;
                  ctx.setLineDash([1, 1]);
                  ctx.beginPath();
                  ctx.moveTo(0, y);
                  ctx.lineTo(layout2.width, y);
                  ctx.stroke();
                  ctx.setLineDash([]);
                }
              }, {
                ...
                value: function last_bar() {
                  if (!this.comp.data.length)
                    return void 0;
                  var layout2 = this.comp.$props.layout;
                  var last = this.comp.data[this.comp.data.length - 1];
                  var y = layout2.$2screen(last[4]);
                  return {
                    y,
                    price: last[4],
            ...
            ;
            const Candlesvue_type_script_lang_js_ = {
              name: "Candles",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
            ...
            ;
            const overlays_Candlesvue_type_script_lang_js_ = Candlesvue_type_script_lang_js_;
            ;
            ...
            const Candles = Candles_component.exports;
            ;
            ...
            const Volumevue_type_script_lang_js_ = {
              name: "Volume",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
            ...
            ;
            const overlays_Volumevue_type_script_lang_js_ = Volumevue_type_script_lang_js_;
            ;
            ...
            const Volume = Volume_component.exports;
            ;
            const Splittersvue_type_script_lang_js_ = {
              name: "Splitters",
              mixins: [overlay],
              methods: {
                meta_info: function meta_info() {
            ...
            ;
            const overlays_Splittersvue_type_script_lang_js_ = Splittersvue_type_script_lang_js_;
            ;
            ...
            const Splitters = Splitters_component.exports;
            ;
            ...
            var Keys = function() {
              function Keys2(comp) {
                classCallCheck_classCallCheck(this, Keys2);
                this.comp = comp;
                this.map = {};
                this.listeners = 0;
                this.keymap = {};
              }
              createClass_createClass(Keys2, [{
                key: "on",
            ...
            ;
            var Pin = function() {
              function Pin2(comp, name, params) {
                var _this = this;
                if (params === void 0) {
                  params = {};
                }
                classCallCheck_classCallCheck(this, Pin2);
            ...
            ;
            var Seg = function() {
              function Seg2(overlay2, ctx) {
                classCallCheck_classCallCheck(this, Seg2);
                this.ctx = ctx;
                this.comp = overlay2;
                this.T = overlay2.$props.config.TOOL_COLL;
                if (utils.is_mobile)
                  this.T *= 2;
              }
              createClass_createClass(Seg2, [{
                key: "draw",
                value: function draw(p1, p2) {
                  var layout2 = this.comp.$props.layout;
                  var x1 = layout2.t2screen(p1[0]);
                  var y1 = layout2.$2screen(p1[1]);
                  var x2 = layout2.t2screen(p2[0]);
                  var y2 = layout2.$2screen(p2[1]);
            ...
            ;
            var Line = function() {
              function Line2(overlay2, ctx) {
                classCallCheck_classCallCheck(this, Line2);
                this.ctx = ctx;
                this.comp = overlay2;
                this.T = overlay2.$props.config.TOOL_COLL;
                if (utils.is_mobile)
            ...
            function typeof_typeof(obj) {
              ...
              if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {
                typeof_typeof = function _typeof2(obj2) {
                  return typeof obj2;
                };
              } else {
                typeof_typeof = function _typeof2(obj2) {
            ...
            var Ray = function(_Line) {
              _inherits(Ray2, _Line);
              var _super = _createSuper(Ray2);
              function Ray2(overlay2, ctx) {
                var _this;
                classCallCheck_classCallCheck(this, Ray2);
                _this = _super.call(this, overlay2, ctx);
                _this.ray = true;
                return _this;
              }
              return Ray2;
            ...
            ;
            const LineToolvue_type_script_lang_js_ = {
              name: "LineTool",
              mixins: [overlay, tool],
              methods: {
                meta_info: function meta_info() {
            ...
            ;
            const overlays_LineToolvue_type_script_lang_js_ = LineToolvue_type_script_lang_js_;
            ;
            ...
            const LineTool = LineTool_component.exports;
            ;
            const RangeToolvue_type_script_lang_js_ = {
              name: "RangeTool",
              mixins: [overlay, tool],
              methods: {
                meta_info: function meta_info() {
                ...
                draw: function draw(ctx) {
                  ...
                  var layout2 = this.$props.layout;
                  var xm = layout2.t2screen((this.p1[0] + this.p2[0]) * 0.5);
                  ctx.lineWidth = this.line_width;
                  ctx.strokeStyle = this.color;
                  ctx.fillStyle = this.back_color;
                  var x1 = layout2.t2screen(this.p1[0]);
                ...
                horizontal: function horizontal(ctx, x1, y1, x2, y2, xm) {
                  ...
                  var ym = (layout2.$2screen(this.p1[1]) + layout2.$2screen(this.p2[1])) / 2;
                  ctx.beginPath();
                  if (!this.shift) {
            ...
            ;
            const overlays_RangeToolvue_type_script_lang_js_ = RangeToolvue_type_script_lang_js_;
            ;
            ...
            const RangeTool = RangeTool_component.exports;
            ;
            ...
            const Gridvue_type_script_lang_js_ = {
              name: "Grid",
              ...
              render: function render2(h) {
                ...
                var layout2 = this.$props.layout.grids[id];
              ...
              methods: {
                ...
                inject_renderer: function inject_renderer(comp) {
                  var src2 = comp.methods.calc();
                  if (!src2.conf || !src2.conf.renderer || comp.__renderer__) {
                    return comp;
                  }
                  var f = this._list.find(function(x) {
                    return x.name === src2.conf.renderer;
                  });
                  if (!f)
                    return comp;
                  comp.mixins.push(f);
                  comp.__renderer__ = src2.conf.renderer;
                  return comp;
                }
              },
              computed: {
            ...
            ;
            const components_Gridvue_type_script_lang_js_ = Gridvue_type_script_lang_js_;
            ;
            ...
            const components_Grid = Grid_component.exports;
            ;
            ...
            var Sidebar = function() {
              function Sidebar2(canvas2, comp, side) {
                if (side === void 0) {
                  side = "right";
                }
                classCallCheck_classCallCheck(this, Sidebar2);
              ...
              createClass_createClass(Sidebar2, [{
                key: "listeners",
                value: function listeners() {
                  var _this = this;
                  var mc = this.mc = new hammer.Manager(this.canvas);
            ...
            ;
            const Sidebarvue_type_script_lang_js_ = {
              name: "Sidebar",
            ...
            ;
            const components_Sidebarvue_type_script_lang_js_ = Sidebarvue_type_script_lang_js_;
            ;
            ...
            const components_Sidebar = Sidebar_component.exports;
            ;
            ...
            ;
            const LegendButtonvue_type_script_lang_js_ = {
              name: "LegendButton",
            ...
            ;
            const components_LegendButtonvue_type_script_lang_js_ = LegendButtonvue_type_script_lang_js_;
            var LegendButtonvue_type_style_index_0_lang_css_ = __webpack_require__2(169);
            ;
            ;
            ;
            ...
            const LegendButton = LegendButton_component.exports;
            ;
            const ButtonGroupvue_type_script_lang_js_ = {
              name: "ButtonGroup",
            ...
            ;
            const components_ButtonGroupvue_type_script_lang_js_ = ButtonGroupvue_type_script_lang_js_;
            var ButtonGroupvue_type_style_index_0_lang_css_ = __webpack_require__2(886);
            ;
            ;
            ;
            ...
            const ButtonGroup = ButtonGroup_component.exports;
            ;
            ...
            ;
            const Spinnervue_type_script_lang_js_ = {
              name: "Spinner",
              props: ["colors"]
            };
            ;
            const components_Spinnervue_type_script_lang_js_ = Spinnervue_type_script_lang_js_;
            var Spinnervue_type_style_index_0_lang_css_ = __webpack_require__2(372);
            ;
            ;
            ;
            ...
            const Spinner = Spinner_component.exports;
            ;
            const Legendvue_type_script_lang_js_ = {
              name: "ChartLegend",
            ...
            ;
            const components_Legendvue_type_script_lang_js_ = Legendvue_type_script_lang_js_;
            var Legendvue_type_style_index_0_lang_css_ = __webpack_require__2(600);
            ;
            ;
            ;
            ...
            const Legend = Legend_component.exports;
            ;
            ...
            ;
            const Sectionvue_type_script_lang_js_ = {
              name: "GridSection",
            ...
            ;
            const components_Sectionvue_type_script_lang_js_ = Sectionvue_type_script_lang_js_;
            var Sectionvue_type_style_index_0_lang_css_ = __webpack_require__2(11);
            ;
            ;
            ;
            ...
            const Section = Section_component.exports;
            ;
            ...
            var Botbar = function() {
              function Botbar2(canvas2, comp) {
                classCallCheck_classCallCheck(this, Botbar2);
                this.canvas = canvas2;
                this.ctx = canvas2.getContext("2d");
                this.comp = comp;
                this.$p = comp.$props;
              ...
              createClass_createClass(Botbar2, [{
                key: "update",
                value: function update2() {
                ...
                key: "apply_shaders",
                value: function apply_shaders() {
                  var layout2 = this.layout.grids[0];
                  var props = {
                    layout: layout2,
                    cursor: this.$p.cursor
                  };
            ...
            ;
            const Botbarvue_type_script_lang_js_ = {
              name: "Botbar",
            ...
            ;
            const components_Botbarvue_type_script_lang_js_ = Botbarvue_type_script_lang_js_;
            var Botbarvue_type_style_index_0_lang_css_ = __webpack_require__2(124);
            ;
            ;
            ...
            const components_Botbar = Botbar_component.exports;
            ;
            const Keyboardvue_type_script_lang_js_ = {
              name: "Keyboard",
              created: function created() {
            ...
            ;
            const components_Keyboardvue_type_script_lang_js_ = Keyboardvue_type_script_lang_js_;
            ;
            ...
            const Keyboard = Keyboard_component.exports;
            ;
            const datatrack = {
              methods: {
            ...
            var TI = function() {
              function TI2() {
                classCallCheck_classCallCheck(this, TI2);
                this.ib = false;
              }
              createClass_createClass(TI2, [{
                key: "init",
                ...
                value: function gt2i(smth, ohlcv) {
                  if (smth > MAX_ARR) {
                    var E = 0.1;
                    var _Utils$fast_nearest = utils.fast_nearest(ohlcv, smth + E), _Utils$fast_nearest2 = _slicedToArray(_Utils$fast_nearest, 2), i1 = _Utils$fast_nearest2[0], i2 = _Utils$fast_nearest2[1];
                    if (typeof i1 === "number") {
                      return i1;
                    } else {
                      return this.t2i(smth);
            ...
            ;
            const Chartvue_type_script_lang_js_ = {
              name: "Chart",
              ...
              methods: {
                ...
                subset: function subset(range) {
                  ...
                  var _this$filter = this.filter(this.ohlcv, range[0] - this.interval, range[1]), _this$filter2 = _slicedToArray(_this$filter, 2), res = _this$filter2[0], index = _this$filter2[1];
                  this.ti_map = new TI();
                  if (res) {
            ...
            ;
            const components_Chartvue_type_script_lang_js_ = Chartvue_type_script_lang_js_;
            ;
            ;
            ...
            const Chart = Chart_component.exports;
            ;
            var Toolbarvue_type_template_id_021887fb_render = function() {
              ...
              return _c(
                ...
                _vm._l(_vm.groups, function(tool2, i) {
                  return tool2.icon && !tool2.hidden ? _c("toolbar-item", {
                    key: i,
                    attrs: {
                      data: tool2,
                      subs: _vm.sub_map,
                      ...
                      config: _vm.config,
                      colors: _vm.colors,
                      selected: _vm.is_selected(tool2)
                    },
            ...
            ;
            const ItemListvue_type_script_lang_js_ = {
              name: "ItemList",
            ...
            ;
            const components_ItemListvue_type_script_lang_js_ = ItemListvue_type_script_lang_js_;
            var ItemListvue_type_style_index_0_lang_css_ = __webpack_require__2(807);
            ;
            ;
            ;
            ...
            const ItemList = ItemList_component.exports;
            ;
            const ToolbarItemvue_type_script_lang_js_ = {
              name: "ToolbarItem",
              ...
              methods: {
                ...
                emit_selected: function emit_selected(src2) {
            ...
            ;
            const components_ToolbarItemvue_type_script_lang_js_ = ToolbarItemvue_type_script_lang_js_;
            var ToolbarItemvue_type_style_index_0_lang_css_ = __webpack_require__2(501);
            ;
            ;
            ;
            ...
            const ToolbarItem = ToolbarItem_component.exports;
            ;
            ...
            const Toolbarvue_type_script_lang_js_ = {
              name: "Toolbar",
              ...
              methods: {
                selected: function selected(tool2) {
                  this.$emit("custom-event", {
                    event: "tool-selected",
                    args: [tool2.type]
                  });
                  if (tool2.group) {
                    this.sub_map[tool2.group] = tool2.type;
                  }
                },
                is_selected: function is_selected(tool2) {
                  var _this = this;
                  if (tool2.group) {
                    return !!tool2.items.find(function(x) {
                      return x.type === _this.data.tool;
                    });
                  }
                  return tool2.type === this.data.tool;
                }
              },
              computed: {
                styles: function styles() {
                ...
                groups: function groups() {
                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                      var tool2 = _step.value;
                      if (!tool2.group) {
                        arr.push(tool2);
                        continue;
                      }
                      var g = arr.find(function(x) {
                        return x.group === tool2.group;
                      });
                      if (!g) {
                        arr.push({
                          group: tool2.group,
            ...
            ;
            const components_Toolbarvue_type_script_lang_js_ = Toolbarvue_type_script_lang_js_;
            var Toolbarvue_type_style_index_0_lang_css_ = __webpack_require__2(153);
            ;
            ;
            ;
            ...
            const Toolbar = Toolbar_component.exports;
            ;
            ...
            ;
            const Widgetsvue_type_script_lang_js_ = {
              name: "Widgets",
            ...
            ;
            const components_Widgetsvue_type_script_lang_js_ = Widgetsvue_type_script_lang_js_;
            var Widgetsvue_type_style_index_0_lang_css_ = __webpack_require__2(5);
            ;
            ;
            ;
            ...
            const Widgets = Widgets_component.exports;
            ;
            ...
            ;
            const TheTipvue_type_script_lang_js_ = {
              name: "TheTip",
              props: ["data"],
              mounted: function mounted() {
                var _this = this;
            ...
            ;
            const components_TheTipvue_type_script_lang_js_ = TheTipvue_type_script_lang_js_;
            var TheTipvue_type_style_index_0_lang_css_ = __webpack_require__2(477);
            ;
            ;
            ;
            ...
            const TheTip = TheTip_component.exports;
            ;
            ...
            const TradingVuevue_type_script_lang_js_ = {
              name: "TradingVue",
              components: {
                Chart,
                Toolbar,
            ...
            ;
            const src_TradingVuevue_type_script_lang_js_ = TradingVuevue_type_script_lang_js_;
            var TradingVuevue_type_style_index_0_lang_css_ = __webpack_require__2(863);
            ;
            ;
            ;
            ...
            const TradingVue = TradingVue_component.exports;
            ;
            ...
            var regenerator = __webpack_require__2(757);
            ...
            var lz_string = __webpack_require__2(961);
            var lz_string_default = __webpack_require__2.n(lz_string);
            ;
            var WebWork = function() {
              function WebWork2(dc) {
                classCallCheck_classCallCheck(this, WebWork2);
                this.dc = dc;
                this.tasks = {};
              ...
              createClass_createClass(WebWork2, [{
                key: "start",
                ...
                key: "exec",
                value: function() {
                  var _exec = _asyncToGenerator(regenerator_default().mark(function _callee(type, data, tx_keys) {
                    var _this3 = this;
                ...
                key: "relay",
                value: function() {
                  var _relay = _asyncToGenerator(regenerator_default().mark(function _callee2(event, just) {
                    var _this4 = this;
            ...
            var BUF_INC = 5;
            var tf_cache = {};
            function f_args(src2) {
              FDEFS.lastIndex = 0;
              var m = FDEFS.exec(src2);
              if (m) {
            ...
            function f_body(src2) {
              return src2.slice(src2.indexOf("{") + 1, src2.lastIndexOf("}"));
            }
            function wrap_idxs(src2, pre) {
              if (pre === void 0) {
                pre = "";
              }
              ...
              do {
                ...
                if (m) {
                  ...
                  src2 = src2.replace(m[0], wrap);
                  changed = true;
                }
              } while (m);
              return changed ? src2 : src2;
            }
            function make_module_lib(mod) {
              ...
              for (var k in mod) {
                if (k === "main" || k === "id")
                  continue;
                var a = f_args(mod[k]);
                lib2[k] = new Function(a, f_body(mod[k]));
              }
              return lib2;
            }
            ...
            var Dataset = function() {
              function Dataset2(dc, desc) {
                classCallCheck_classCallCheck(this, Dataset2);
                this.type = desc.type;
                this.id = desc.id;
                this.dc = dc;
                if (desc.data) {
              ...
              createClass_createClass(Dataset2, [{
                key: "set",
                ...
                key: "data",
                value: function() {
                  var _data = _asyncToGenerator(regenerator_default().mark(function _callee() {
                    var ds;
                    return regenerator_default().wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                      ...
                      if (!pids.includes(id)) {
                        ...
                        this.dss[id] = new Dataset2(this, ds);
                      }
                    }
                  } catch (err) {
                    _iterator.e(err);
            ...
            var DCEvents = function() {
              function DCEvents2() {
                var _this = this;
                classCallCheck_classCallCheck(this, DCEvents2);
              ...
              createClass_createClass(DCEvents2, [{
                key: "on_custom_event",
                ...
                value: function register_tools(tools) {
                  ...
                  try {
                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done; ) {
                      var tool2 = _step3.value;
                      preset[tool2.type] = tool2;
                      delete tool2.type;
                    }
                  } catch (err) {
                    _iterator3.e(err);
                  ...
                  try {
                    for (_iterator4.s(); !(_step4 = _iterator4.n()).done; ) {
                      var tool2 = _step4.value;
                      var proto = Object.assign({}, tool2.info);
                      var type = tool2.info.type || "Default";
                      proto.type = "".concat(tool2.use_for, ":").concat(type);
                      this.merge_presets(proto, preset[tool2.use_for]);
                      this.merge_presets(proto, preset[proto.type]);
                      delete proto.mods;
                      list.push(proto);
                      for (var mod in tool2.info.mods) {
                        var mp = Object.assign({}, proto);
                        mp = Object.assign(mp, tool2.info.mods[mod]);
                        mp.type = "".concat(tool2.use_for, ":").concat(mod);
                        this.merge_presets(mp, preset[tool2.use_for]);
            ...
            var DCCore = function(_DCEvents) {
              _inherits(DCCore2, _DCEvents);
              var _super = dc_core_createSuper(DCCore2);
              function DCCore2() {
                classCallCheck_classCallCheck(this, DCCore2);
                return _super.apply(this, arguments);
              }
              createClass_createClass(DCCore2, [{
                key: "init_tvjs",
                ...
                key: "range_changed",
                value: function() {
                  var _range_changed = _asyncToGenerator(regenerator_default().mark(function _callee(range, tf, check) {
                    var _this2 = this;
                    var first, prom;
                    return regenerator_default().wrap(function _callee$(_context) {
                      while (1) {
                ...
                value: function update_candle(data) {
                  ...
                  var now2 = data.t || utils.now();
                  var t = now2 >= t_next ? now2 - now2 % tf : last[0];
                  if (candle.length >= 6) {
                    t = candle[0];
                  } else {
                ...
                key: "combine",
                value: function combine(dst, o, src2) {
                  function last(arr) {
                  ...
                  if (src2[0][0] >= dst[0][0] && last(src2) <= last(dst)) {
                    return Object.assign(dst, o);
                  } else if (last(src2) > last(dst)) {
                    if (o.length < 1e5 && src2.length < 1e5) {
                      var _dst;
                      (_dst = dst).push.apply(_dst, _toConsumableArray(o).concat(_toConsumableArray(src2)));
                      return dst;
                    } else {
                      return dst.concat(o, src2);
                    }
                  } else if (src2[0][0] < dst[0][0]) {
                    if (o.length < 1e5 && src2.length < 1e5) {
                      var _src;
                      (_src = src2).push.apply(_src, _toConsumableArray(o).concat(_toConsumableArray(dst)));
                      return src2;
                    } else {
                      return src2.concat(o, dst);
                    }
                  } else {
                    return [];
                  }
            ...
            ;
            var AggTool = function() {
              function AggTool2(dc, _int) {
                if (_int === void 0) {
                  _int = 100;
                }
                classCallCheck_classCallCheck(this, AggTool2);
                this.symbols = {};
                this["int"] = _int;
                this.dc = dc;
                this.st_id = null;
              ...
              createClass_createClass(AggTool2, [{
                key: "push",
            ...
            var DataCube = function(_DCCore) {
              _inherits(DataCube2, _DCCore);
              var _super = datacube_createSuper(DataCube2);
              function DataCube2(data, sett) {
                var _this;
                if (data === void 0) {
                  data = {};
                }
                ...
                classCallCheck_classCallCheck(this, DataCube2);
                var def_sett = {
                  aggregation: 100,
                  script_depth: 0,
                  auto_scroll: true,
              ...
              createClass_createClass(DataCube2, [{
                key: "add",
                value: function add(side, overlay2) {
                  if (side !== "onchart" && side !== "offchart" && side !== "datasets") {
                    return;
                  }
                  this.data[side].push(overlay2);
                  this.update_ids();
                  return overlay2.id;
                }
              }, {
            ...
            const src = TradingVue;
          },
          418: (module2, exports2, __webpack_require__2) => {
          ...
          976: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.trading-vue-botbar {\n    position: relative !important;\n}\n", ""]);
            module2.exports = exports2;
          },
          449: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.t-vue-lbtn-grp {\n    margin-left: 0.5em;\n}\n", ""]);
            module2.exports = exports2;
          },
          108: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.tvjs-item-list {\n    position: absolute;\n    user-select: none;\n    margin-top: -5px;\n}\n.tvjs-item-list-item {\n    display: flex;\n    align-items: center;\n    padding-right: 20px;\n    font-size: 1.15em;\n    letter-spacing: 0.05em;\n}\n.tvjs-item-list-item:hover {\n    background-color: #76878319;\n}\n.tvjs-item-list-item * {\n    position: relative !important;\n}\n", ""]);
            module2.exports = exports2;
          },
          988: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.trading-vue-legend {\n    position: relative;\n    z-index: 100;\n    font-size: 1.25em;\n    margin-left: 10px;\n    pointer-events: none;\n    text-align: left;\n    user-select: none;\n    font-weight: 300;\n}\n@media (min-resolution: 2x) {\n.trading-vue-legend {\n        font-weight: 400;\n}\n}\n.trading-vue-ohlcv {\n    pointer-events: none;\n    margin-bottom: 0.5em;\n}\n.t-vue-lspan {\n    font-variant-numeric: tabular-nums;\n    font-size: 0.95em;\n    color: #999999; /* TODO: move => params */\n    margin-left: 0.1em;\n    margin-right: 0.2em;\n}\n.t-vue-title {\n    margin-right: 0.25em;\n    font-size: 1.45em;\n}\n.t-vue-ind {\n    margin-left: 0.2em;\n    margin-bottom: 0.5em;\n    font-size: 1.0em;\n    margin-top: 0.3em;\n}\n.t-vue-ivalue {\n    margin-left: 0.5em;\n}\n.t-vue-unknown {\n    color: #999999; /* TODO: move => params */\n}\n.tvjs-appear-enter-active,\n.tvjs-appear-leave-active\n{\n    transition: all .25s ease;\n}\n.tvjs-appear-enter, .tvjs-appear-leave-to\n{\n    opacity: 0;\n}\n", ""]);
            module2.exports = exports2;
          },
          423: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.t-vue-lbtn {\n    z-index: 100;\n    pointer-events: all;\n    cursor: pointer;\n}\n", ""]);
            module2.exports = exports2;
          },
          661: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.trading-vue-section {\n    height: 0;\n    position: absolute;\n}\n", ""]);
            module2.exports = exports2;
          },
          168: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.tvjs-spinner {\n    display: inline-block;\n    position: relative;\n    width: 20px;\n    height: 16px;\n    margin: -4px 0px -1px 0px;\n    opacity: 0.7;\n}\n.tvjs-spinner div {\n    position: absolute;\n    top: 8px;\n    width: 4px;\n    height: 4px;\n    border-radius: 50%;\n    animation-timing-function: cubic-bezier(1, 1, 1, 1);\n}\n.tvjs-spinner div:nth-child(1) {\n    left: 2px;\n    animation: tvjs-spinner1 0.6s infinite;\n    opacity: 0.9;\n}\n.tvjs-spinner div:nth-child(2) {\n    left: 2px;\n    animation: tvjs-spinner2 0.6s infinite;\n}\n.tvjs-spinner div:nth-child(3) {\n    left: 9px;\n    animation: tvjs-spinner2 0.6s infinite;\n}\n.tvjs-spinner div:nth-child(4) {\n    left: 16px;\n    animation: tvjs-spinner3 0.6s infinite;\n    opacity: 0.9;\n}\n@keyframes tvjs-spinner1 {\n0% {\n        transform: scale(0);\n}\n100% {\n        transform: scale(1);\n}\n}\n@keyframes tvjs-spinner3 {\n0% {\n        transform: scale(1);\n}\n100% {\n        transform: scale(0);\n}\n}\n@keyframes tvjs-spinner2 {\n0% {\n        transform: translate(0, 0);\n}\n100% {\n        transform: translate(7px, 0);\n}\n}\n", ""]);
            module2.exports = exports2;
          },
          29: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.tvjs-drift-enter-active {\n    transition: all .3s ease;\n}\n.tvjs-drift-leave-active {\n    transition: all .8s cubic-bezier(1.0, 0.5, 0.8, 1.0);\n}\n.tvjs-drift-enter, .tvjs-drift-leave-to\n{\n    transform: translateX(10px);\n    opacity: 0;\n}\n.tvjs-the-tip {\n    position: absolute;\n    width: 200px;\n    text-align: center;\n    z-index: 10001;\n    color: #ffffff;\n    font-size: 1.5em;\n    line-height: 1.15em;\n    padding: 10px;\n    border-radius: 3px;\n    right: 70px;\n    top: 10px;\n    text-shadow: 1px 1px black;\n}\n", ""]);
            module2.exports = exports2;
          },
          935: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.trading-vue-toolbar {\n    position: absolute;\n    border-right: 1px solid black;\n    z-index: 101;\n    padding-top: 3px;\n    user-select: none;\n}\n", ""]);
            module2.exports = exports2;
          },
          379: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.trading-vue-tbitem {\n}\n.trading-vue-tbitem:hover {\n    background-color: #76878319;\n}\n.trading-vue-tbitem-exp {\n    position: absolute;\n    right: -3px;\n    padding: 18.5px 5px;\n    font-stretch: extra-condensed;\n    transform: scaleX(0.6);\n    font-size: 0.6em;\n    opacity: 0.0;\n    user-select: none;\n    line-height: 0;\n}\n.trading-vue-tbitem:hover\n.trading-vue-tbitem-exp {\n    opacity: 0.5;\n}\n.trading-vue-tbitem-exp:hover {\n    background-color: #76878330;\n    opacity: 0.9 !important;\n}\n.trading-vue-tbicon {\n    position: absolute;\n}\n.trading-vue-tbitem.selected-item > .trading-vue-tbicon,\n.tvjs-item-list-item.selected-item > .trading-vue-tbicon {\n     filter: brightness(1.45) sepia(1) hue-rotate(90deg) saturate(4.5) !important;\n}\n.tvjs-pixelated {\n    -ms-interpolation-mode: nearest-neighbor;\n    image-rendering: -webkit-optimize-contrast;\n    image-rendering: -webkit-crisp-edges;\n    image-rendering: -moz-crisp-edges;\n    image-rendering: -o-crisp-edges;\n    image-rendering: pixelated;\n}\n\n", ""]);
            module2.exports = exports2;
          },
          72: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.trading-vue-ux-wrapper {\n    position: absolute;\n    display: flex;\n}\n.tvjs-ux-wrapper-pin {\n    position: absolute;\n    width: 9px;\n    height: 9px;\n    z-index: 100;\n    background-color: #23a776;\n    border-radius: 10px;\n    margin-left: -6px;\n    margin-top: -6px;\n    pointer-events: none;\n}\n.tvjs-ux-wrapper-head {\n    position: absolute;\n    height: 23px;\n    width: 100%;\n}\n.tvjs-ux-wrapper-close {\n    position: absolute;\n    width: 11px;\n    height: 11px;\n    font-size: 1.5em;\n    line-height: 0.5em;\n    padding: 1px 1px 1px 1px;\n    border-radius: 10px;\n    right: 5px;\n    top: 5px;\n    user-select: none;\n    text-align: center;\n    z-index: 100;\n}\n.tvjs-ux-wrapper-close-hb {\n}\n.tvjs-ux-wrapper-close:hover {\n    background-color: #FF605C !important;\n    color: #692324 !important;\n}\n.tvjs-ux-wrapper-full {\n}\n", ""]);
            module2.exports = exports2;
          },
          983: (module2, exports2, __webpack_require__2) => {
            var ___CSS_LOADER_API_IMPORT___ = __webpack_require__2(645);
            exports2 = ___CSS_LOADER_API_IMPORT___(false);
            exports2.push([module2.id, "\n.tvjs-widgets {\n    position: absolute;\n    z-index: 1000;\n    pointer-events: none;\n}\n", ""]);
            module2.exports = exports2;
          ...
          840: (module2, exports2, __webpack_require__2) => {
          ...
          961: (module2, exports2, __webpack_require__2) => {
            var __WEBPACK_AMD_DEFINE_RESULT__;
          ...
          863: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(418);
          ...
          124: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(976);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          886: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(449);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          807: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(108);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          600: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(988);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          169: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(423);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          11: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(661);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          372: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(168);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          477: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(29);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          501: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(379);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          5: (module2, __unused_webpack_exports, __webpack_require__2) => {
            var content = __webpack_require__2(983);
            if (content.__esModule)
              content = content.default;
            if (typeof content === "string")
              content = [[module2.id, content, ""]];
          ...
          346: (__unused_webpack_module, __webpack_exports__2, __webpack_require__2) => {
            "use strict";
            __webpack_require__2.d(__webpack_exports__2, {
              "Z": () => addStylesClient
            });
...
export default require_trading_vue();
/*!
...
* Licensed under the MIT license */
//# sourceMappingURL=trading-vue-js.js.map
